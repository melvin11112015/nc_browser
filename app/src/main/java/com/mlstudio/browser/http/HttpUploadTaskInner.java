...
public class HttpUploadTaskInner extends AsyncTask<String, Void, String> {

	List<NameValuePair> params;
	InputStream uploadStream = null;
    private OnTaskCompleted listener;

	public HttpUploadTaskInner(OnTaskCompleted listener, List<NameValuePair> params,
							   InputStream f) {
	...
	private String downloadUrl(String postUrl) {
		...
		try {
			...
			InputStream fStream = uploadStream;
			/* 设置每次写入1024bytes */
