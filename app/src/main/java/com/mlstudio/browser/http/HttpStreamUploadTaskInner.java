...
public class HttpStreamUploadTaskInner extends AsyncTask<String, Void, String> {
	...
	InputStream uploadedBytes = null;
    private OnUploadTaskHandler listener;

	public HttpStreamUploadTaskInner(OnUploadTaskHandler listener,
									 List<NameValuePair> params, InputStream f) {
	...
	private String downloadUrl(String postUrl) {
		...
		try {
			...
			InputStream fStream = uploadedBytes;
			/* 设置每次写入1024bytes */
