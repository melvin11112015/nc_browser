...
package com.mlstudio.browser.ui;
...
import com.mlstudio.browser.utils.DensityUtil;
import com.mlstudio.browser.utils.GlideUtil;
...
public class TopBarView extends LinearLayout {
	...
	private void initView() {
		...
		textLeftBtn = findViewById(R.id.text_left_btn);
		...
		mMiddleSub = findViewById(R.id.btn_middle_sub);
	...
	public void showTopProgressbar() {
		...
		findViewById(R.id.top_progressbar)
