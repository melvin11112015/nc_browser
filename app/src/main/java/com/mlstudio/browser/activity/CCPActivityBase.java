...
import com.mlstudio.browser.ui.CCPLayoutListenerView;
import com.mlstudio.browser.ui.TopBarView;
import com.mlstudio.browser.ui.VerticalImageSpan;
import com.mlstudio.browser.utils.AudioManagerTools;
...
public abstract class CCPActivityBase {
     ...
     */
        ...
        CCPLayoutListenerView listenerView = mActionBarActivity.findViewById(R.id.ccp_content_fl);
    ...
    public final void hideTitleView() {
        LogUtil.d(LogUtil.getLogUtilsTag(AppBaseActivity.class), "hideTitleView hasTitle :" + (mTopBarView != null));
        if(mTopBarView != null) {
    ...
    public final void showTitleView() {
        LogUtil.d(LogUtil.getLogUtilsTag(AppBaseActivity.class), "showTitleView hasTitle :" + (mTopBarView != null));
        if(mTopBarView != null) {
