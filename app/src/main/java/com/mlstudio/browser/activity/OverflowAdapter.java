...
public class OverflowAdapter extends CommAdapter {
    ...
    private void findViewId(View convertView) {
        ...
        holder.icon = convertView.findViewById(R.id.popup_menu_item_left_image);
        holder.title = convertView.findViewById(R.id.popup_menu_item_name);
        holder.root = convertView.findViewById(R.id.popup_container);
        holder.point = convertView.findViewById(R.id.popup_menu_image_red);
