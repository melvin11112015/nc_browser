...
package com.mlstudio.browser.dialog;
...
public class ECAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private void initView() {
        ...
        Button middleBtn = findViewById(R.id.dilaog_button2);
        middleBtn.setOnClickListener(this);
        mButtons.add(middleBtn);
        Button rightBtn = findViewById(R.id.dilaog_button3);
        rightBtn.setOnClickListener(this);
        mButtons.add(rightBtn);
        mLayoutTitle = findViewById(R.id.dialog_layout_title);
        mLayoutContent = findViewById(R.id.dialog_layout_content);
    ...
    public void setTitle(CharSequence text) {
        if ((text == null) || (TextUtils.isEmpty(text.toString()))) {
            ...
            findViewById(R.id.dialog_tv_title).setVisibility(View.GONE);
