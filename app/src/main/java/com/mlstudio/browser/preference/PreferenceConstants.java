...
public class PreferenceConstants {
	...
	public final static String CollectType = "CollectType";


	public final static String ChatId = "ChatId";
	public final static String ChatPwd = "ChatPwd";

	public final static String PicTags = "PicTags";
	public final static String NewsTags = "NewsTags";
	public final static String BookmarkInited = "BookmarkInited";

	public final static String UserName = "UserName";
	public final static String UserSign = "UserSign";
	public final static String UserPhoto = "UserPhoto";
	public final static String UserId = "UserId";
	public final static String RecentAccount = "RecentAccount";

	public final static String UploadId = "UploadId";
	public final static String News_Inited = "News_Inited";

	public final static String TopicCircleSelectedImage = "TopicCircleSelectedImage";
	public final static String TopicCircleSelectedId = "TopicCircleSelectedId";
	public final static String TopicCircleSelectedName = "TopicCircleSelectedName";


	public final static String City = "City";

	public final static String WebShareType = "WebShareType";
	public final static String ACCOUNT = "UserId";
	...
	public final static String RegistUserId = "RegistUserId";
	public final static String RegistUserPwd = "RegistUserPwd";
